package com.uty.serfis_lab_meet7
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_instagram.setOnClickListener({
            val i=Intent(Intent.ACTION_VIEW,
                Uri.parse("https://www.instagram.com/langitinspirasi.co.id"))
            startActivity(i)
        })

        //mendeklarasi variabel media player dan memanggil data mp3
        var MediaPlayer:MediaPlayer?=MediaPlayer.create(this,R.raw.black)

        //button yang berfungsi untuk melakukan mp3
